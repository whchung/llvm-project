...
AMDGPUFunctionArgInfo::getPreloadedValue(
  ...
  case AMDGPUFunctionArgInfo::KERNELARG0:
    return std::make_tuple(PreloadedKernArg[0] ? &PreloadedKernArg[0] : nullptr,
                           &AMDGPU::SGPR_64RegClass,
                           LLT::pointer(AMDGPUAS::CONSTANT_ADDRESS, 64));
  case AMDGPUFunctionArgInfo::KERNELARG1:
    return std::make_tuple(PreloadedKernArg[1] ? &PreloadedKernArg[1] : nullptr,
                           &AMDGPU::SGPR_64RegClass,
                           LLT::pointer(AMDGPUAS::CONSTANT_ADDRESS, 64));
  case AMDGPUFunctionArgInfo::KERNELARG2:
    return std::make_tuple(PreloadedKernArg[2] ? &PreloadedKernArg[2] : nullptr,
                           &AMDGPU::SGPR_64RegClass,
                           LLT::pointer(AMDGPUAS::CONSTANT_ADDRESS, 64));
