// ./bin/mlir-opt --convert-linalg-to-affine-loops --lower-affine --convert-std-to-llvm ../mlir/examples/prototypes/threadwise_gemm.mlir | ./bin/mlir-cpu-runner -e main --entry-point-result=void -shared-libs=lib/libmlir_runner_utils.so
...
func @main() -> (){
  ...
  call @print_memref_2d_f32(%C):(memref<4x7xf32>) -> ()
  return 
}
